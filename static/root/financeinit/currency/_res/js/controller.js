var app = angular.module('currency', [{
    files:[
        "root/financeinit/currency/_res/js/service.js"
    ]
}]);
app.controller('currencyCtrl',function ($scope,$state) {
    ...
    $scope.delete = function(){
        if($scope.idList){
            $state.go('root.financeinit.currency.list[12]',{id:$scope.idList,name:'delete',page:$scope.page});
    ...
    $scope.edit = function(){
        if($scope.idList){
            $state.go('root.financeinit.currency.edit[12]',{id:$scope.idList,page:$scope.page});
