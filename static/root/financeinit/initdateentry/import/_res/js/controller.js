var app = angular.module('initdateentryImport', ['toastr']);
app.controller('initdateentryImportCtrl', function($scope,initdateentrySer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/initdateentry/templateExcel');
    };
    //删除文件
