...
app.controller('rootCtrl', function ($scope,$rootScope,$state,ipCookie,$location,rootSer) {
    ...
    $scope.back=function () {
        var forword=ipCookie('forward');
        ipCookie('forword','',{expires:-1})
        window.location.href=forword? forword:'https://show.issp.bjike.com/system.html';
    }
