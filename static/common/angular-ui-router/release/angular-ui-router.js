...
/**
 * Performs a non-strict account of the subset of two objects, defined by a list of keys.
 *
...
UrlMatcher.prototype.exec = function (path, searchParams) {
  ...
  if (nPath !== m.length - 1) throw new Error("Unbalanced capture withunit in route '" + this.source + "'");
