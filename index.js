...
//============路由===========
app.use(require(path.join(__dirname,routersPath,'/financeinit/index.js'))().routes());//项目测算
app.use(require(path.join(__dirname,routersPath,'/versionInfo/index.js'))().routes());//项目测算
